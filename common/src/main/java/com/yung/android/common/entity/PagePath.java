...
public class PagePath {
    ...
    public static final String ACTIVITY_CONFIG_CHANGE_LIFECYCLE = "/basic/activity/configchangelifecycle";

    public static final String ACTIVITY_LAUNCH_MODE = "/basic/activity/launchmode";

    public static final String ACTIVITY_BROADCAST_STATIC = "/basic/broadcast/static";
